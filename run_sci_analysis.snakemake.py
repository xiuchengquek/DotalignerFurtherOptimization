...
rule all :
    input: sci_files, 'out/merged/seq.index.txt', 'out/merged/combination.index.txt', 'out/merged/merged_sci_diff.txt', 'out/merged/ranked.tsv'
...
rule conduct_rank_analysis:
    input : 'out/merged/merged_sci_diff.txt'
    output : 'out/merged/ranked.tsv'
    shell : 'python src/sciAnalysis/rankAnalysis.py -m {input} -o {output}'
