        ...
        with unittest.mock.patch('os.path.exists', mock_object ) as m :
            with unittest.mock.patch.object(DotAlignerWrapper, 'run_dotaligner') as dot_mock:
                ...
                dot_mock.assert_called_with(
                    "(time -f '\t%E\t%M' /found -k 0.5 -t 0.5 -o 1 -e 0.2 -s 10 -T 1 a_dp.pp b_dp.pp; ) >> out/k_0.5-t_0.5-o_1-e_0.2-T_1.dotaligner.out 2>&1",
                    ['a','b'],
    ...
    def test_run_dotaligner(self):
        ...
        with unittest.mock.patch('os.path.exists', mock_object ) as m :
            ...
            with unittest.mock.patch('builtins.open', fh):
                ...
                handle = fh()
                calls_list =  [
                    calls("(time -f '\t%E\t%M' /found -k 0.5 -t 0.5 -o 1 -e 10 -s 10 -T 1 a_dp.pp b_dp.pp; ) >> out/k_0.5-t_0.5-o_1-e_10-T_1.dotaligner.out 2>&1\n" +\
                          "(time -f '\t%E\t%M' /found -k 0.5 -t 0.5 -o 1 -e 10 -s 10 -T 1 b_dp.pp c_dp.pp; ) >> out/k_0.5-t_0.5-o_1-e_10-T_1.dotaligner.out 2>&1"),
                    calls("(time -f '\t%E\t%M' /found -k 0.5 -t 0.5 -o 1 -e 20 -s 10 -T 1 a_dp.pp b_dp.pp; ) >> out/k_0.5-t_0.5-o_1-e_20-T_1.dotaligner.out 2>&1\n" +\
                          "(time -f '\t%E\t%M' /found -k 0.5 -t 0.5 -o 1 -e 20 -s 10 -T 1 b_dp.pp c_dp.pp; ) >> out/k_0.5-t_0.5-o_1-e_20-T_1.dotaligner.out 2>&1")
                ]
